...
(use-package
  conda
  :hook
  ;; hook below needed for auto-activation, see README and issue 93 of necaris/conda.el
  (find-file . (lambda ()
...
(use-package
  projectile
  :custom (projectile-project-search-path '("~/libraries" "~/data-science" "~/web-apps"
					    "~/proposals"))
