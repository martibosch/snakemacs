...
- Org, Markdown and LaTeX for writing things up: citations completed from a `references.bib` next to your document with [citar](https://github.com/emacs-citar/citar), and PDF export through [tectonic](https://tectonic-typesetting.github.io) or a system TeX Live.
...
- [Org](https://snakemacs.readthedocs.io/en/latest/org), [Markdown](https://snakemacs.readthedocs.io/en/latest/markdown) and [LaTeX](https://snakemacs.readthedocs.io/en/latest/latex) - citations and PDF export
